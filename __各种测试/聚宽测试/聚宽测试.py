...
gdx_jax, gdx_ylx, gdx_zcx = GDX(security_list1,check_date='2023-01-01', N = 30, M = 9)

# 输出 security_list2 的 GDX 值
gdx_jax, gdx_ylx, gdx_zcx = GDX(security_list2,check_date='2023-01-01', N = 30, M = 9)
...
macd_dif, macd_dea, macd_macd = MACD(security_list1,check_date='2023-01-01', SHORT = 12, LONG = 26, MID = 9)
print(macd_dif[security_list1])
print(macd_dea[security_list1])
print(macd_macd[security_list1])

# 输出 security_list2 的 MACD 值
macd_dif, macd_dea, macd_macd = MACD(security_list2,check_date='2023-01-01', SHORT = 12, LONG = 26, MID = 9)
for stock in security_list2:
